...
public class CircularProgressBar extends ProgressBar{
	...
	public void init(AttributeSet attrs, int style){
		...
		this.mHasShadow = a.getBoolean(R.styleable.CircularProgressBar_cHasShadow, true);

		color = a.getString(R.styleable.CircularProgressBar_cProgressColor);
		if(color==null)
		...
		color = a.getString(R.styleable.CircularProgressBar_cBackgroundColor);
		if(color==null)
		...
		color = a.getString(R.styleable.CircularProgressBar_cTitleColor);
		if(color==null)
			mTitlePaint.setColor(res.getColor(R.color.circular_progress_default_title));
		else
			mTitlePaint.setColor(Color.parseColor(color));

		color = a.getString(R.styleable.CircularProgressBar_cSubtitleColor);
		if(color==null)
		...
		String t = a.getString(R.styleable.CircularProgressBar_cTitle);
		if(t!=null)
			mTitle = t;

		t = a.getString(R.styleable.CircularProgressBar_cSubtitle);
		if(t!=null)
			mSubTitle = t;

		mStrokeWidth = a.getInt(R.styleable.CircularProgressBar_cStrokeWidth, STROKE_WIDTH);
